...
static void basic_init(void)
{
    ...
    lv_style_set_bg_color(&style_bg, LV_STATE_DEFAULT, MY_GUI_LIGHT);
    ...
    lv_style_set_value_color(&style_box, LV_STATE_DEFAULT, MY_GUI_BLUE);
    ...
    lv_style_set_border_color(&style_box_border, LV_STATE_DEFAULT, MY_GUI_GRAY);
    lv_style_set_text_color(&style_box, LV_STATE_DEFAULT, MY_GUI_BLUE);

    /***************************/
    lv_style_init(&style_list);
		
		
    //lv_style_set_clip_corner(&style_list, LV_STATE_DEFAULT, true);
   // lv_style_set_bg_opa(&style_list, LV_STATE_DEFAULT, LV_OPA_COVER);
   // lv_style_set_radius(&style_list, LV_STATE_DEFAULT, 0);
   // lv_style_set_value_color(&style_list, LV_STATE_DEFAULT, MY_GUI_BLUE);
   // lv_style_set_value_font(&style_list, LV_STATE_DEFAULT, theme.font_normal);
	  lv_style_init(&style_list);
    lv_style_set_bg_opa(&style_list, LV_STATE_DEFAULT, LV_OPA_COVER);
    lv_style_set_bg_color(&style_list, LV_STATE_DEFAULT, MY_GUI_BLUE);
    lv_style_set_text_font(&style_list, LV_STATE_DEFAULT, &lv_font_montserrat_20);
    ...
    lv_style_set_bg_color(&style_label, LV_STATE_DEFAULT, MY_GUI_RED);
    ...
    lv_style_set_bg_color(&style_btn, LV_STATE_PRESSED, MY_GUI_LIGHT_GRAY);
    lv_style_set_bg_color(&style_btn, LV_STATE_FOCUSED, MY_GUI_LIGHT_GRAY);
    lv_style_set_bg_color(&style_btn, LV_STATE_CHECKED, MY_GUI_GRAY);
    lv_style_set_text_color(&style_btn, LV_STATE_DEFAULT, MY_GUI_BLUE);
    lv_style_set_text_color(&style_btn, LV_STATE_PRESSED, lv_color_darken(MY_GUI_BLUE, LV_OPA_20));
    lv_style_set_text_color(&style_btn, LV_STATE_CHECKED, LV_COLOR_WHITE);
    lv_style_set_image_recolor(&style_btn, LV_STATE_DEFAULT, MY_GUI_BLUE);
    lv_style_set_image_recolor(&style_btn, LV_STATE_PRESSED, lv_color_darken(MY_GUI_BLUE, LV_OPA_20));
    ...
    lv_style_set_bg_color(&style_btn_neutral, LV_STATE_DEFAULT, MY_GUI_BLUE);
    lv_style_set_bg_color(&style_btn_neutral, LV_STATE_FOCUSED, lv_color_darken(MY_GUI_BLUE, LV_OPA_30));
    lv_style_set_bg_color(&style_btn_neutral, LV_STATE_PRESSED, lv_color_darken(MY_GUI_BLUE, LV_OPA_30));
    ...
    lv_style_set_shadow_color(&style_btn_neutral, LV_STATE_DEFAULT, MY_GUI_BLUE);
    ...
    lv_style_set_bg_color(&style_btn_negative, LV_STATE_FOCUSED, lv_color_darken(MY_GUI_RED, LV_OPA_30));
    lv_style_set_bg_color(&style_btn_negative, LV_STATE_PRESSED, lv_color_darken(MY_GUI_RED, LV_OPA_30));
    lv_style_set_bg_color(&style_btn_negative, LV_STATE_DEFAULT, MY_GUI_RED);
    ...
    lv_style_set_shadow_color(&style_btn_negative, LV_STATE_DEFAULT, MY_GUI_RED);
    ...
    lv_style_set_bg_color(&style_btn_positive, LV_STATE_FOCUSED, lv_color_darken(MY_GUI_LIGHT_GREEN, LV_OPA_30));
    lv_style_set_bg_color(&style_btn_positive, LV_STATE_PRESSED, lv_color_darken(MY_GUI_LIGHT_GREEN, LV_OPA_30));
    lv_style_set_bg_color(&style_btn_positive, LV_STATE_DEFAULT, MY_GUI_LIGHT_GREEN);
    ...
    lv_style_set_shadow_color(&style_btn_positive, LV_STATE_DEFAULT, MY_GUI_LIGHT_GREEN);
    ...
    lv_style_set_bg_color(&style_cont, LV_STATE_PRESSED, MY_GUI_LIGHT_GRAY);
    lv_style_set_bg_color(&style_cont, LV_STATE_FOCUSED, MY_GUI_LIGHT_GRAY);
    lv_style_set_bg_color(&style_cont, LV_STATE_CHECKED, MY_GUI_GRAY);
    ...
    lv_style_set_line_width(&style_chart, LV_STATE_DEFAULT, 1);
    ...
    lv_style_set_value_color(&style_back, LV_STATE_PRESSED, MY_GUI_LIGHT_GRAY);
    ...
    lv_style_set_bg_color(&style_bar_bg, LV_STATE_DEFAULT, MY_GUI_LIGHT_GRAY);

    lv_style_init(&style_bar_indic);
    lv_style_set_bg_color(&style_bar_indic, LV_STATE_DEFAULT, MY_GUI_LIGHT_GREEN);
    ...
    lv_style_set_bg_color(&style_scrollbar, LV_STATE_DEFAULT, MY_GUI_LIGHT_ORANGE);
    ...
    lv_style_set_bg_opa(&style_list_btn, LV_STATE_DEFAULT, LV_OPA_COVER);
		lv_style_set_bg_color(&style_list, LV_STATE_DEFAULT, MY_GUI_BLUE);
    lv_style_set_bg_color(&style_list_btn, LV_STATE_PRESSED, MY_GUI_LIGHT_BLUE);
    lv_style_set_bg_color(&style_list_btn, LV_STATE_FOCUSED, MY_GUI_LIGHT_BLUE);
    lv_style_set_bg_color(&style_list_btn, LV_STATE_CHECKED, MY_GUI_GRAY);
    lv_style_set_text_color(&style_list_btn, LV_STATE_DEFAULT, MY_GUI_BLUE);
    lv_style_set_text_color(&style_list_btn, LV_STATE_PRESSED, lv_color_darken(MY_GUI_BLUE, LV_OPA_20));
    lv_style_set_text_color(&style_list_btn, LV_STATE_CHECKED, LV_COLOR_WHITE);
    lv_style_set_image_recolor(&style_list_btn, LV_STATE_DEFAULT, MY_GUI_BLUE);
    lv_style_set_image_recolor(&style_list_btn, LV_STATE_PRESSED, lv_color_darken(MY_GUI_BLUE, LV_OPA_20));
    lv_style_set_image_recolor(&style_list_btn, LV_STATE_CHECKED, LV_COLOR_WHITE);
    lv_style_set_pad_left(&style_list_btn, LV_STATE_DEFAULT, 10);
    lv_style_set_pad_right(&style_list_btn, LV_STATE_DEFAULT, 10);
    lv_style_set_pad_top(&style_list_btn, LV_STATE_DEFAULT, 10);
    lv_style_set_pad_bottom(&style_list_btn, LV_STATE_DEFAULT, 10);
    lv_style_set_pad_inner(&style_list_btn, LV_STATE_DEFAULT, 10);
    ...
    lv_style_set_shadow_color(&style_ddlist_list, LV_STATE_DEFAULT, MY_GUI_GRAY);

    lv_style_init(&style_ddlist_selected);
    lv_style_set_bg_opa(&style_ddlist_selected, LV_STATE_DEFAULT, LV_OPA_COVER);
    lv_style_set_bg_color(&style_ddlist_selected, LV_STATE_DEFAULT, MY_GUI_LIGHT_GRAY);
    lv_style_set_bg_color(&style_ddlist_selected, LV_STATE_PRESSED, MY_GUI_LIGHT_GRAY);
    lv_style_set_text_color(&style_ddlist_selected, LV_STATE_PRESSED, lv_color_darken(MY_GUI_GRAY, LV_OPA_20));

    lv_style_init(&style_sw_bg);
    lv_style_set_bg_opa(&style_sw_bg, LV_STATE_DEFAULT, LV_OPA_COVER);
    lv_style_set_bg_color(&style_sw_bg, LV_STATE_DEFAULT, MY_GUI_GRAY);
    lv_style_set_radius(&style_sw_bg, LV_STATE_DEFAULT, LV_RADIUS_CIRCLE);
    lv_style_set_value_color(&style_sw_bg, LV_STATE_DEFAULT, MY_GUI_BLUE);

    lv_style_init(&style_sw_indic);
    lv_style_set_bg_opa(&style_sw_indic, LV_STATE_DEFAULT, LV_OPA_COVER);
    lv_style_set_bg_color(&style_sw_indic, LV_STATE_DEFAULT,MY_GUI_GREEN);
    ...
    lv_style_set_bg_color(&style_slider_knob, LV_STATE_DEFAULT, MY_GUI_LIGHT_BLUE);
...
static void theme_apply(lv_obj_t * obj, lv_theme_style_t name)
{
    ...
    switch(name_int) {
        ...
        case LV_THEME_LIST:   //for list
            lv_obj_clean_style_list(obj, LV_LIST_PART_BG);
            list = lv_obj_get_style_list(obj, LV_LIST_PART_BG);
            _lv_style_list_add_style(list, &style_list);
